...
const Banner = () => {
  return (
    <div>
      ...
      {/* features-card-start */}
      <div className="max-w-7xl mx-auto">
        <div className="lg:ms-32 md:ms-32">
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-5 lg:py-8 md:py-6 py-2 mx-2">
            <div>
              <img className="w-11 ms-7" src={icon1} alt="" />
              <h1 className="mt-2">Airport transfer</h1>
            </div>
            <div>
              <img className="w-11 ms-5" src={icon2} alt="" />
              <h1 className="mt-2">All inclusive</h1>
            </div>
            <div>
              <img className="w-11 ms-7" src={icon3} alt="" />
              <h1 className="mt-2">Air-conditioned</h1>
            </div>
            <div>
              <img className="w-11 ms-7" src={icon4} alt="" />
